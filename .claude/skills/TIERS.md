---
name: Skill Tier Map
description: Which skills unlock at which price tier
---

# Skill Tiers

## Explore (Free)
Try before you buy. Limited extraction, see the system work.
...
The `/publish` and `/campaign` skills connect to:
